...
<body>
    ...
    <div class="container">
        <div class="isi">
            <h2 style="text-align:center;">DATA KONSULTASI SISWA KESELURUHAN DARI DARI {{carbon\carbon::parse($tgl_awal)->translatedFormat('d F Y')}} SAMPAI {{carbon\carbon::parse($tgl_akhir)->translatedFormat('d F Y')}}</h2>
