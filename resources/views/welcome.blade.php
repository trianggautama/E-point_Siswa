...
<body>
    ...
    <header class="header-area">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="#">
                                <img src="{{asset('depan/images/logo.svg')}}" alt="Logo">
                            </a>
        ...
        <div id="home" class="header-hero bg_cover" style="background-image: url(depan/images/header-bg.jpg)">
            <div class="container">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing pro mt-40">
                        <div class="pricing-baloon">
                            <img src="{{asset('depan/images/baloon.svg')}}" alt="baloon">
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing enterprise mt-40">
                        <div class="pricing-flower">
                            <img src="{{asset('depan/images/flower.svg')}}" alt="flower">
                        </div>
