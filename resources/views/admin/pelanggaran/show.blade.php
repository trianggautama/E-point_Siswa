    ...
    <div class="container pd-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
                ...
                <h4 class="mg-b-0 tx-spacing--1">Detail Pelanggaran Siswa</h4>
            </div>
            <div class="d-none d-md-block">
                <a href="{{Route('pelanggaranIndex')}}" class="btn btn-sm pd-x-15 btn-secondary btn-uppercase mg-l-5"><i data-feather="arrow-left"
            ...
            <div class="col-md-12 col-xl-12 mg-t-5">
              <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-10">Jenis Pelanggaran</label>
                            <p class="mg-b-0 text-justify">{{$data->pedoman->uraian}}</p>
                        </div>
                        <div class="form-group">
                            <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-10">Pengurangan poin</label>
