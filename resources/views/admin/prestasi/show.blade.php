            ...
            <div class="col-md-12 col-xl-12 mg-t-5">
              <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-10">Nama Kejuaraan / Lomba</label>
                            <p class="mg-b-0 text-justify">-</p>
                        </div>
                        <div class="form-group">
                            <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-10">Penyelenggara</label>
                            <p class="mg-b-0  ">-</p>
                        </div>
                        <div class="form-group">
                            <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-10">tingkat</label> <br>
                            <p class="mg-b-0  ">-</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tanggal_prestasi" id="tanggal_prestasi">
                    </div>
                    <div class="form-group">
